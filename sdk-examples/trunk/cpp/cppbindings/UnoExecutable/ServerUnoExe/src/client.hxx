...
#ifndef __UNO_EXE_CLIENT__
#define __UNO_EXE_CLIENT__
...
{
    typedef ::cppu::WeakImplHelper1< css::lang::XMain > ClientUnoExe_Base;

    class ClientUnoExe : public ClientUnoExe_Base
    {
        private:
            css::uno::Reference< css::uno::XComponentContext > m_xContext;

        public:
            ClientUnoExe( const css::uno::Reference< css::uno::XComponentContext > &rxContext );
            ~ClientUnoExe();
