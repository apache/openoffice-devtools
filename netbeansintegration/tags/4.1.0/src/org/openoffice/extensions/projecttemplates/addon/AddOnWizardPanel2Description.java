 ...
 */
public class AddOnWizardPanel2Description implements WizardDescriptor.Panel,
        WizardDescriptor.ValidatingPanel, WizardDescriptor.FinishablePanel, AddOnActions.ActionPanel {
    
    private WizardDescriptor wizardDescriptor;
    private AddOnPanelVisual2Description component;
    
    /** Creates a new instance of templateWizardPanel */
    public AddOnWizardPanel2Description() {
    }
    
    public Component getComponent() {
        if (component == null) {
            component = new AddOnPanelVisual2Description(this);
