 ...
 */
public class ComponentWizardPanel1Project implements WizardDescriptor.Panel,
    ...
    public Component getComponent() {
        if (component == null) {
            component = new ComponentPanelVisual1Project(this);
            component.setName(NbBundle.getMessage(ComponentWizardPanel1Project.class, "LBL_CreateProjectStep"));
        }
        return component;
    }
